...
public partial class RuleView : UserControl
{
    ...
    private void LoadWeaponNumber(WeaponNumberObj obj) 
    {
    ...
    private void Button_NumberWeaponInfo_Add_Click(object sender, RoutedEventArgs e)
    {
    ...
    private void Button_NumberWeaponInfo_Remove_Click(object sender, RoutedEventArgs e)
    {
        AudioUtils.ClickSound();
    ...
    private void Button_NumberWeaponInfo_Clear_Click(object sender, RoutedEventArgs e)
    {
        AudioUtils.ClickSound();
